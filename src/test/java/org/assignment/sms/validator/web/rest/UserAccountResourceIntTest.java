...
import org.assignment.sms.validator.repository.UserAccountRepository;
import org.assignment.sms.validator.service.UserAccountService;
import org.assignment.sms.validator.service.dto.UserAccountDTO;
import org.assignment.sms.validator.service.mapper.UserAccountMapper;
...
public class UserAccountResourceIntTest {
    ...
    public void createUserAccount() throws Exception {
        ...
        assertThat(testUserAccount.getAuthId()).isEqualTo(DEFAULT_AUTH_ID);
    ...
    public void updateUserAccount() throws Exception {
        ...
        UserAccount testUserAccount = userAccountList.get(userAccountList.size() - 1);
        assertThat(testUserAccount.getAuthId()).isEqualTo(UPDATED_AUTH_ID);
